...
class FrontPageOptions
{
    ...
    public function add_plugin_page()
    {
        ...
        add_options_page(
            'Settings Admin', 
            esc_html__( 'Front Page', 'chocolita' ), 
            'manage_options', 
    ...
    public function create_admin_page()
    {
        ...
        ?>
        <div class="wrap">
            <h2><?php esc_html__( 'Front Page', 'chocolita' ) ?></h2>           
    ...
    {        
        ...
        add_settings_section(
            ...
            esc_html__( 'Front Page Options', 'chocolita' ), // Title
        ...
        add_settings_field(
            'event_name', // ID
            esc_html__( 'Event name', 'chocolita' ), // Title 
        ...
        add_settings_field(
            'event_date', 
            esc_html__( 'Event date', 'chocolita' ), 
        ...
        add_settings_field(
            'event_venue', 
            esc_html__( 'Event venue', 'chocolita' ), 
        ...
        add_settings_field(
            'event_desc', 
            esc_html__( 'Event description', 'chocolita' ), 
        ...
        add_settings_field(
            'event_btn', 
            esc_html__( 'Button text', 'chocolita' ), 
        ...
        add_settings_field(
            'event_url', 
            esc_html__( 'Button URL', 'chocolita' ), 
    ...
    {
        print esc_html__( 'This is the configuration page for the main event on the Front Page.', 'chocolita' );
    }
    ...
    {
        printf(
            '<input type="text" id="event_name" name="portada_option_name[event_name]" value="%s" /><p class="description">'.esc_html__( 'Enter the event short name. E.g. VIII ECSL 2016.', 'chocolita' ).'</p>',
    ...
    {
        printf(
            '<input type="text" id="event_date" name="portada_option_name[event_date]" value="%s" /><p class="description">'.esc_html__( 'Enter the date range. E.g. June 16-18, 2016.', 'chocolita' ).'</p>',
    ...
    {
        printf(
            '<input type="text" id="event_venue" name="portada_option_name[event_venue]" value="%s" /><p class="description">'.esc_html__( 'Enter the city and country. E.g. Managua, Nicaragua.', 'chocolita' ).'</p>',
    ...
    {
        printf(
            '<textarea cols="50" rows="5" id="event_desc" name="portada_option_name[event_desc]" value="%s">'. esc_textarea( $this->options["event_desc"] ) .'</textarea><p class="description">'.esc_html__( 'Short description of the event. 150 characters or less.', 'chocolita' ).'</p>',
    ...
    {
        printf(
            '<input type="text" id="event_btn" name="portada_option_name[event_btn]" value="%s" /><p class="description">'.esc_html__( 'Call-to-action button text.', 'chocolita' ).'</p>',
    ...
    {
        printf(
            '<input type="text" id="event_url" name="portada_option_name[event_url]" value="%s" /><p class="description">'.esc_html__( 'Enter the event website URL.', 'chocolita' ).'</p>',
